namespace Projem.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        {
            CreateTable(
                "dbo.DepartmanBilgileris",
                c => new
                    {
                        DepartmanBilgileriId = c.Int(nullable: false, identity: true),
                        DepartmanAdi = c.String(maxLength: 25),
                    })
                .PrimaryKey(t => t.DepartmanBilgileriId);
                ...
                c => new
                    {
                        ...
                        YakinTC = c.String(maxLength: 15),
                        YakinAdSoyad = c.String(maxLength: 25),
                        YakinTel = c.String(maxLength: 15),
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.DepartmanBilgileris");
        }
    }
}
